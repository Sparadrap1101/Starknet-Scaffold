...
import classes from '../FigmaComponents/MacBookPro162.module.css';
        ...
        <span>
          ...
          >
            <text
              x="10"
              y="30"
              fontFamily="Kanit, system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', 'Liberation Sans', sans-serif"
              fontSize={34}
              fontWeight={300}
              letter-spacing={10}
